...
<div id="content">
			...
			<table class="table table-striped table-bordered" style="margin-top:10px;" id="set_table" <?php if(($info["id"]) > "0"): else: ?>style="display:none"<?php endif; ?>>
				...
				<tr>
					...
					<td colspan="3" class="lt">
						<input type="text" name="username" class="ipt" size="45" value="<?php echo ($info["username"]); ?>" readonly>
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td><strong>用户token：</strong></td>
					<td colspan="3" class="lt">
						<input type="text" name="token" class="ipt" size="45" value="<?php echo ($info["token"]); ?>" / readonly>
					</td>
				</tr>
				...
				<tr>
					<td><strong>可创建活动数：</strong></td>
					<td colspan="3" class="lt">
						<input type="text" name="sum" class="ipt" size="45" value="<?php echo ($info['sum']); ?>") />
					</td>
				</tr>
				...
				<tr>
					...
					<td colspan="3" class="lt">
						<input type="text" name="overtime" class="ipt" size="45" value=<?php echo date('Y-m-d H:i:s', $info['overtime']) ?> />
					</td>
				</tr>
				...
				<tr>
					...
					<td colspan="3" class="lt">
						<input type="radio" class="radio" class="ipt" value="1" name="status" id="status1" <?php if(($info["status"] == 1) ): ?>checked=""<?php endif; ?> >
							启用
	...
	<tr>
		...
		<input type="hidden" name="id" value=<?php echo ($info["id"]); ?>>
				...
				<input class="btn" type="submit" name="dosubmit" value="修 改" >
