...
return  array(
    ...
    'APP_GROUP_LIST'        => 'Home,Admin,User,Wap,Chat',      // 项目分组设定,多个组之间用逗号分隔,例如'Home,Admin'
    ...
    'TMPL_ACTION_ERRORS'     => THINK_PATH.'Tpl/dis_jump.tpl', // 默认错误跳转对应的模板文件
    'TMPL_ACTION_SUCCESSS'   => THINK_PATH.'Tpl/dis_jump.tpl', // 默认成功跳转对应的模板文件
    'TMPL_EXCEPTION_FILE'   => THINK_PATH. 'Tpl/think_exception2.tpl',// 异常页面的模板文件
